 ...
 */
@Api(value = "事件描述管理", tags = {"事件描述管理"})
@RestController
@RequestMapping("event/event-desc")
public class InfoEventDescriptionController extends AbstractController {
    @Autowired
...
//            @ApiImplicitParam(paramType = "query", name = "eventTargetName", value = "事件标签名称", required = false, dataType = "str")
//    })
//    @GetMapping("/page")
//    public R page(@RequestParam Map<String, Object> params) {
//        PageUtils page = infoEventDescriptionService.queryPage(params);
//
...
//    }
    ...
    public R list(@RequestParam Map<String, Object> params) {
        return R.ok().put("list", infoEventDescriptionService.list(
                new QueryWrapper<InfoEventDescriptionEntity>()
    ...
    public R info(@PathVariable("id") Long id) {
        InfoEventDescriptionEntity entity = infoEventDescriptionService.getById(id);
    ...
    @PostMapping("/save")
    public R save(@RequestBody InfoEventDescriptionEntity entity) {
        ValidatorUtils.validateEntity(entity);
        entity.setCreatedBy(getUserId());
        entity.setCreatedDate(DateUtils.getTimestamp());
        infoEventDescriptionService.save(entity);
    ...
    @PutMapping("/update")
    public R update(@RequestBody InfoEventDescriptionEntity entity) {
        ValidatorUtils.validateEntity(entity);
        entity.setModifiedBy(getUserId());
        entity.setModifiedDate(DateUtils.getTimestamp());
        infoEventDescriptionService.updateById(entity);
    ...
    public R delete(@PathVariable("id") Long id) {
        ...
        try {
            infoEventDescriptionService.delById(id, getUserId());
        } catch (Exception e) {
            e.printStackTrace();
            return R.error("修改失败");
        }
    ...
    public R deleteBatch(@RequestBody DeleteBatchVo deleteBatchVo) {
        ...
        try {
            infoEventDescriptionService.deleteBatch(deleteBatchVo.getIds(), getUserId());
        } catch (Exception e) {
            e.printStackTrace();
