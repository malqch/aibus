 ...
 * the License.
 */
package com.wntime.ec.common.util.id;
...
public class IdSequence {
     ...
     */
    public IdSequence(long workerId, long datacenterId) throws SystemException {
        if (workerId > maxWorkerId || workerId < 0) {
            throw new SystemException(String.format("worker Id can't be greater than %d or less than 0", maxWorkerId));
        }
