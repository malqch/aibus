...
/**
* @创建时间：2020-08-27 02:38:26
* @文件描述：info_fault_target @desc 故障标签表
*/
@ApiModel(description = "@desc 故障标签表" )
@Data
public class InfoFaultTarget implements Serializable {
	...
	*/ 
	...
	@ApiModelProperty(value="@desc 主键",name="faultTargetId",required=true) 
	protected Long faultTargetId;

	/**
	* @desc 故障标签名称
	*/ 
	@Size(max=20 ,message ="@desc 故障标签名称最多20个字符",groups=AddGroup.class) 
	@ApiModelProperty(value="@desc 故障标签名称",name="faultTargetName",required=false) 
	protected String faultTargetName;
	...
	*/ 
	...
	@ApiModelProperty(value="@desc 标签分类编码 @value link、value、char",name="faultTargetGrope",required=false)
	protected String faultTargetGrope;

	/**
	* @desc 故障标签编码
	*/ 
	@Size(max=20 ,message ="@desc 故障标签编码最多20个字符",groups=AddGroup.class) 
	@ApiModelProperty(value="@desc 故障标签编码",name="faultTargetCode",required=false) 
	protected String faultTargetCode;
