...
public class DistanceUtil {
    ...
    public static void main(String[] args) {
        System.out.println(getShortestDistance(126.051606, 41.78163, 126.053018, 41.790432));
        System.out.println(distVincenty(30.760696, 104.068392, 30.76044, 104.070831));
