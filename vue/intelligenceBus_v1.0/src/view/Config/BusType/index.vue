    ...
    <div>
        ...
        <div class="cotroller_box">
            <el-form ref="form" :model="form" label-width="120px" style="width:100%">
                <el-form-item label="校车车型名称">
                    <el-input v-model="form.busTypeName" placeholder="请输入" style="float: left;width:190px;margin-left:10px;height:42px;" clearable @clear="clearInput"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="busTypeName" label="校车车型名称" min-width="140"></el-table-column>
                        <el-table-column prop="busTypeCode" label="校车车型编码" min-width="140"></el-table-column>
...
<!--                        <el-table-column label="校车车型照片" min-width="120">-->
<!--                        <template slot-scope="scope">-->
<!--                            <el-image-->
<!--                                style="height: 40px"-->
<!--                                :src="scope.row.busTypeImage"-->
<!--                                :preview-src-list="[scope.row.busTypeImage]"-->
<!--                                fit="scale-down"></el-image>-->
<!--                        </template>-->
<!--                        </el-table-column>-->
                        <el-table-column prop="busTypeDesc" label="车型说明" min-width="100" :show-overflow-tooltip="false">
                            <template slot-scope="scope">
                                <el-tooltip class="item" effect="dark" placement="top">
                                    <div v-html="scope.row.busTypeDesc" slot="content"></div>
                                    <div class="lineCls">{{changeBr(scope.row.busTypeDesc)}}</div>
                                </el-tooltip>
                            </template>
                        </el-table-column>
                        <el-table-column prop="warrantyMileage" label="质保里程(km)" min-width="100"></el-table-column>
                        <el-table-column prop="warrantyYears" label="质保年数" min-width="100"></el-table-column>
                        <el-table-column prop="peopleNumber" label="核载人数" min-width="100"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.busTypeId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.busTypeId, scope.row.busTypeName)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getInfoBusTypeList, deleteInfoBusType, deleteInfoBusTypeAll} from "@/api/parameter";
        ...
        methods: {
            ...
            dataFormSubmit : function(){
                if(this.deleteAllForm.validatePassword == ''){
                    ...
                    deleteInfoBusTypeAll(this.deleteAllForm).then((res) => {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].busTypeId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getInfoBusTypeList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
