        ...
        <div class="cotroller_box">
            <el-form ref="form" :model="form" label-width="120px" style="width:100%">
                <el-form-item label="事件类型名称">
                    <el-input v-model="form.eventTypeName" placeholder="请输入" style="float: left;width:190px;margin-left:10px;height:42px;" clearable @clear="clearInput"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="eventTypeName" label="事件类型名称" min-width="100"></el-table-column>
                        <el-table-column prop="eventTypeCode" label="事件类型编码" min-width="100"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.eventTypeId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.eventTypeId, scope.row.eventTypeName)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getInfoEventTypePage, deleteInfoEventType, deleteInfoEventTypeAll} from "@/api/event";
        ...
        methods: {
            ...
            dataFormSubmit : function(){
                if(this.deleteAllForm.validatePassword == ''){
                    ...
                    deleteInfoEventTypeAll(this.deleteAllForm).then((res) => {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].eventTypeId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getInfoEventTypePage(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
