<!--
 ...
 @Mail:
 @Date: 2020-08-28
 @file-description: @desc 订单交付表组件页面
-->
        ...
        <div class="cotroller_box">
            <el-form ref="form" :model="form" label-width="120px" style="width:100%">
                <el-form-item label="参数名称">
                    <el-input v-model="form.paramName" placeholder="请输入" style="float: left;width:190px;margin-left:10px;height:42px;" clearable @clear="clearInput"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="companyDeliveryId" label="@desc 主键" min-width="100"></el-table-column>
                        <el-table-column prop="orderId" label="@desc 订单Id" min-width="100"></el-table-column>
                        <el-table-column prop="busTypeId" label="@desc 公交车型Id" min-width="100"></el-table-column>
                        <el-table-column prop="orderDeliveryNum" label="@desc 交付数量" min-width="100"></el-table-column>
                        <el-table-column prop="orderDeliveryDate" label="@desc 交付日期" min-width="100"></el-table-column>
                        <el-table-column prop="orderDetailDesc" label="@desc 说明" min-width="100"></el-table-column>
                        <el-table-column prop="isDeleted" label="@desc 是否删除" min-width="100"></el-table-column>
                        <el-table-column prop="createdDate" label="@desc 创建时间" min-width="100"></el-table-column>
                        <el-table-column prop="modifiedDate" label="@desc 修改时间" min-width="100"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.companyDeliveryId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.companyDeliveryId, null)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getOrderCompanyDeliveryList, deleteOrderCompanyDelivery, deleteOrderCompanyDeliveryAll} from "@/api/parameter";
    import Dialog from "./Dialog";

    export default {
        name: "OrderCompanyDelivery",
        data() {
            return {
                form: {
                    paramName: "",
        ...
        methods: {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].companyDeliveryId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getOrderCompanyDeliveryList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
