        ...
        <div class="cotroller_box">
            <el-form :inline="true" :model="form" class="demo-form-inline">
              <el-form-item label="参数名称">
                <el-input v-model="form.paramName" clearable @clear="clearInput" placeholder="参数名称"></el-input>
              </el-form-item>
              <el-form-item label="参数分组">
                <el-input v-model="form.paramGroup" clearable @clear="clearInput" placeholder="参数分组"></el-input>
              </el-form-item>
              <el-form-item>
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="paramName" label="参数名称" min-width="120"></el-table-column>
                        <el-table-column prop="paramCode" label="参数编码" min-width="130"></el-table-column>
                        <el-table-column prop="paramGroup" label="参数分组" min-width="150"></el-table-column>
                        <el-table-column prop="paramValue" label="数值" min-width="100"></el-table-column>
                        <el-table-column prop="paramChar" label="字符" min-width="140"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.configParamId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.configParamId, scope.row.paramName)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getParameterList, deleteParameter, deleteParameterAll} from "@/api/parameter";
        ...
        methods: {
            ...
            dataFormSubmit : function(){
                if(this.deleteAllForm.validatePassword == ''){
                    ...
                    deleteParameterAll(this.deleteAllForm).then((res) => {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].configParamId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getParameterList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
