    ...
    <div>
        ...
        <div class="cotroller_box">
            <el-form :inline="true" ref="form" :model="form">
                ...
                <el-form-item label="电机编号" style="margin-left:10px;">
                    <el-input v-model="form.busMotorCode" placeholder="请输入" clearable @clear="clearInput"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="motorTypeName" label="电机类型" min-width="100"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.busMotorId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.busMotorId, scope.row.busMotorCode)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getInfoBusMotorList, deleteInfoBusMotor, deleteInfoBusMotorAll} from "@/api/parameter";
    ...
    export default {
        ...
        methods: {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].busMotorId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getInfoBusMotorList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
