        ...
        <div class="cotroller_box">
            <el-form :inline="true" ref="form" :model="form">
                <el-form-item label="公交车VIN">
                    <el-input v-model="form.vinCode" clearable @clear="clearInput" placeholder="公交车VIN"></el-input>
                </el-form-item>
                <el-form-item label="电池编号" style="margin-left:10px;">
                    <el-input v-model="form.busBatteryCode" placeholder="请输入" style="float: left;width:190px;margin-left:10px;height:42px;" clearable @clear="clearInput"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;
                </el-form-item>
                <el-form-item>
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="vinCode" label="公交车VIN" min-width="100"></el-table-column>
                        <el-table-column prop="busTypeName" label="公交车型" min-width="100"></el-table-column>
                        <el-table-column prop="batteryTypeName" label="电池类型" min-width="100"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.busBatteryId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.busBatteryId, scope.row.busBatteryCode)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getInfoBusBatteryList, deleteInfoBusBattery, deleteInfoBusBatteryAll} from "@/api/parameter";
    ...
    export default {
        ...
        methods: {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].busBatteryId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getInfoBusBatteryList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
