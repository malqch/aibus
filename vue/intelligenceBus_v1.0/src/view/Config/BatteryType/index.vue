        ...
        <div class="cotroller_box">
            <el-form ref="form" :model="form" label-width="120px" style="width:100%">
                <el-form-item label="电池型号">
                    <el-input v-model="form.batteryTypeName" placeholder="请输入" style="float: left;width:190px;margin-left:10px;height:42px;" clearable @clear="clearInput"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="batteryTypeName" label="电池型号" min-width="140"></el-table-column>
                        <el-table-column prop="batteryTypeVoltage" label="电池电压(V)" min-width="100"></el-table-column>
                        <el-table-column prop="batteryTypeCurrent" label="电池电流(A)" min-width="100"></el-table-column>
                        <el-table-column prop="batteryTypeEnergy" label="能量(kW.h)" min-width="120"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.batteryTypeId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.batteryTypeId, scope.row.batteryTypeName)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getInfoBatteryTypeList, deleteInfoBatteryType, deleteInfoBatteryTypeAll} from "@/api/parameter";
    import Dialog from "./Dialog";

    export default {
        name: "InfoBatteryType",
        data() {
            return {
                form: {
                    batteryTypeName: "",
        ...
        methods: {
            ...
            dataFormSubmit : function(){
                if(this.deleteAllForm.validatePassword == ''){
                    ...
                    deleteInfoBatteryTypeAll(this.deleteAllForm).then((res) => {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].batteryTypeId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getInfoBatteryTypeList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
