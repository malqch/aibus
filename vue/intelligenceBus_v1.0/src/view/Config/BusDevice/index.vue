        ...
        <div class="cotroller_box">
            <el-form :inline="true" :model="form" class="demo-form-inline">
              ...
              <el-form-item label="设备名称">
                <el-input v-model="form.deviceName" clearable @clear="clearInput" placeholder="设备名称"></el-input>
              </el-form-item>
              <el-form-item label="公交VIN">
                <el-input v-model="form.vinCode" clearable @clear="clearInput" placeholder="公交VIN"></el-input>
              </el-form-item>
              <el-form-item>
                ...
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.busDeviceId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.busDeviceId, scope.row.deviceName)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getInfoBusDeviceList, deleteInfoBusDevice, deleteInfoBusDeviceAll} from "@/api/parameter";
    ...
    export default {
        ...
        methods: {
            ...
            getData : function(page) {
                ...
                getInfoBusDeviceList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
