        ...
        <div class="cotroller_box">
            <el-form :inline="true" ref="form" :model="form" label-width="120px" style="width:100%">
                ...
                <el-form-item label="所在地区" prop="areaName">
                    ...
                    <span style="position: absolute;right:8px;top: 0px;z-index: 0;cursor: pointer;" @click="clearInputSelect">清除</span>
                </el-form-item>
                <el-form-item label="车站名称">
                    <el-input v-model="form.busStationName" placeholder="请输入" style="float: left;width:190px;margin-left:10px;height:42px;" clearable @clear="clearInput"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;
                </el-form-item>
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="areaName" label="所在地区" min-width="100"></el-table-column>
<!--                        <el-table-column prop="busStationCode" label="车站编码" min-width="120"></el-table-column>-->
                        <el-table-column prop="busStationName" label="车站名称" min-width="160"></el-table-column>
                        <el-table-column prop="busStationLongitude" label="经度" min-width="100"></el-table-column>
                        <el-table-column prop="busStationLatitude" label="纬度" min-width="100"></el-table-column>
                        <el-table-column prop="busStationDeviation" label="偏差(米)" min-width="100"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="warning" @click="addOrUpdateHandle(scope.row.busStationId)">
                                    <i class="el-icon-edit"></i>修改</el-button>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.busStationId, scope.row.busStationName)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getInfoBusStationList, deleteInfoBusStation, deleteInfoBusStationAll} from "@/api/parameter";
        ...
        methods: {
            ...
            dataFormSubmit : function(){
                if(this.deleteAllForm.validatePassword == ''){
                    ...
                    deleteInfoBusStationAll(this.deleteAllForm).then((res) => {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].busStationId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getInfoBusStationList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
            ...
            showPopoverHandle: function () {
                ...
                this.$refs.treeRef.setCurrentKey(this.form.areaId);
            },
            // 选中当前节点的数据
