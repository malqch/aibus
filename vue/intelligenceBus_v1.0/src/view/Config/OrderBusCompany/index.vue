        ...
        <div class="cotroller_box">
            <el-form ref="form" :model="form" label-width="120px" style="width:100%">
                <el-form-item label="订单编码">
                    <el-input v-model="form.orderCode" placeholder="请输入" style="float: left;width:190px;margin-left:10px;height:42px;" clearable @clear="clearInput"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="factoryName" label="公交车厂" min-width="140"></el-table-column>
                        <el-table-column prop="orderCode" label="订单编码" min-width="140"></el-table-column>

                        <el-table-column prop="companyName" label="公交公司名称" min-width="140"></el-table-column>
                        <el-table-column prop="orderDetailNum" label="订单数量" min-width="100"></el-table-column>
                        <el-table-column prop="orderDeliveryNum" label="已交付数量" min-width="100"></el-table-column>
                        <el-table-column prop="orderDate" label="签订时间" min-width="100"></el-table-column>
                        <el-table-column prop="sellerName" label="销售员" min-width="100"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-tooltip content="可管理该公交订单的订单详情、订单交付信息" placement="top-start">
                                    <el-button size="mini" type="success" @click="goToDetail(scope.row.orderId)">
                                        <i class="el-icon-edit"></i>详情
                                    </el-button>
                                </el-tooltip>
                                <el-button size="mini" type="danger" @click="handleDelete(scope.row.orderId, scope.row.orderCode)">
                                    <i class="el-icon-delete"></i>删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    import { getOrderBusCompanyList, deleteOrderBusCompany, deleteOrderBusCompanyAll} from "@/api/parameter";
        ...
        methods: {
            ...
            dataFormSubmit : function(){
                if(this.deleteAllForm.validatePassword == ''){
                    ...
                    deleteOrderBusCompanyAll(this.deleteAllForm).then((res) => {
            ...
            handleSelectionChange : function(val){
                ...
                if(this.checkedList.length > 0){
                    for(var i=0;i<this.checkedList.length;i++){
                        this.deleteAllForm.ids.push(this.checkedList[i].orderId)
                    }
                }
            },
            //获取基础列表数据函数
            getData : function(page) {
                ...
                getOrderBusCompanyList(this.form).then((res) => {
                    loading.close();
                    if(res.data && res.data.code === 0){
