            ...
            <div class="table_div">
                <div style="position: relative">
                    <el-table :data="tableData" max-height="450" style="width: 100%"
                        ...
                        <el-table-column prop="collectFault" label="采集内容" min-width="120"></el-table-column>
                        <el-table-column prop="collectCode" label="采集编码" min-width="120"></el-table-column>
                        ...
                        <el-table-column prop="suggestionContent" label="标签方案内容" width="120"></el-table-column>
                        <el-table-column prop="faultLevelName" label="故障级别" width="120"></el-table-column>
                        <el-table-column prop="faultType" label="故障ID" width="120"></el-table-column>
                        <el-table-column prop="faultDetail" label="故障索引码" width="120"></el-table-column>
                        ...
                        <el-table-column label="操作" width="160" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="success" @click="goToDetail(scope.row.collectFaultId)">
...
<script>
    import { getInfoFaultTypeListAll,getInfoFaultTargetListAll,getInfoFaultLevelListAll, getInfoFaultCollectPage, deleteInfoFaultCollect, deleteInfoFaultCollectAll} from "@/api/fault";
    ...
    export default {
        ...
        methods: {
            ...
            getData: function (page) {
                ...
                getInfoFaultCollectPage(this.formQuery).then((res) => {
                    loading.close();
                    if (res.data && res.data.code === 0) {
