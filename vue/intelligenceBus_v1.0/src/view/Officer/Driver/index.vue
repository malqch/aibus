        ...
        <div class="cotroller_box">
            <el-form :inline="true" :model="form" class="demo-form-inline">
              ...
              <el-form-item label="驾驶员姓名">
                <el-input v-model="form.fullName" clearable @clear="clearInput" placeholder="驾驶员姓名"></el-input>
              </el-form-item>
            ...
            <div class="table_div" >
                <div style="position: relative;">
                    <el-table :data="tableData" style="width: 100%" max-height="450" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="drivingLicenseNo" header-align="center" align="center" label="证件号"></el-table-column>
                        <el-table-column prop="firstIssueDate" header-align="center" align="center" label="初次领证" :formatter="formatTime" min-width="140px" ></el-table-column>
                        <el-table-column prop="validPeriodStart" header-align="center" align="center" label="起始时间" :formatter="formatTime" min-width="140px"></el-table-column>
                        <el-table-column prop="validPeriodEnd" header-align="center" align="center" label="结束时间" :formatter="formatTime" min-width="140px"></el-table-column>
                        <el-table-column prop="drivingLicenseClass" header-align="center" align="center" label="准驾车型" ></el-table-column>
                        <el-table-column prop="mobileNumber" header-align="center" align="center" label="手机号"></el-table-column>
                        <el-table-column label="驾驶证照片" min-width="120">
                            <template slot-scope="scope">
                                <el-image
                                    style="height: 40px"
                                    :src="scope.row.driversLicensePhoto"
                                    :preview-src-list="[scope.row.driversLicensePhoto]"
                                    fit="scale-down"></el-image>
                            </template>
                        </el-table-column>
