...
<template>
    ...
    <el-dialog class="dialog_default" title="广告历史信息描述" :close-on-click-modal="false" @close="closeDialog" :visible.sync="visible" style="color:#fff" append-to-body >
    ...
    export default {
        ...
        data() {
            return {
                ...
                showData : {
                    checkStatus : 9,
                    advertiseDeliveryTypeName : '线路',
                    deliveryDate : '2020-11-07 12:00:00 ~ 2020-11-08 12:00:00',
                    deliveryLine : '8路,38路',
                    deliveryStation : '8路,38路',
                    deliveryPeopleAge : '成年,老年',
                    deliveryPeopleGender : '男性',
                    attachList : {
                        rectangleScreen : {
                            fileUrlList : [],
                            advertiseType : 0,
                    ...
                    positionDesc : '1. 38寸长条显示屏，分辨率1366*768，尺寸大小82cm*46cm; 2. 28寸方形显示屏，分辨率1366*768，尺寸大小56cm*56cm'
                } ,
            }
        },
        methods : {
...
<style scoped>
    ...
    .dialog_default_box .card_icon{
        ...
        align-items: center;
        background: radial-gradient( #F79E3E, #F43E53);
